...
import '../../../homeScreen/homeScreenLeaders.dart';
...
class _SweetTalk extends State<SweetTalk> {
  ...
  Future<void> checkSweetTalkExistence() async {
    ...
    bool exists = await New_fire_base_get_data_for_leader.SweetTalkExist(
    ...
    print('SweetTalk exists: $exists');

    setState(() {
      sweetTalkExists = exists;
    });
  }
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                              ...
                              child: Icon(Icons.exit_to_app,color: Colors.red.shade900,size: 30,))
  ...
  bool isValidForm() {
    ...
    print('Text: ${textSweetTalk.text}');
    print('Image URL: $imageUrl');

    if (textSweetTalk.text.trim().isEmpty) {
      print('Validation failed: SweetTalk text is empty');
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    print('Building SweetTalk widget...');
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                sweetTalkExists == null
                    ? Center(child: CircularProgressIndicator())
                    : sweetTalkExists!
                    ? _buildExistingSweetTalk(authProviders)
                    : _buildNewSweetTalkForm(authProviders),
              ],
            ),
          ),
        ),
  ...
  Widget _buildExistingSweetTalk(AuthProviders authProviders) {
    print('Building existing SweetTalk UI');
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: const BorderRadius.only(
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data == null) {
                  print('No data available in SweetTalk collection');
                  return const Center(
                ...
                print('Number of documents in SweetTalk: ${docs.length}');
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: SlideAction(
                        ...
                        onSubmit: () {
                          print('Deleting SweetTalk...');
                          New_fire_base_get_data_for_leader.deleteSweetTalk(
                            governorate: authProviders.governorate!,
                            church: authProviders.churchCodeL!,
                            stage: '${authProviders.stageTypeL!}_${authProviders.stageYearL}',
                          );
  ...
  Widget _buildNewSweetTalkForm(AuthProviders authProviders) {
    print('Building new SweetTalk form');
    return Column(
      children: [
        if (imageUrl == null)
          Center(
            child: Container(
              ...
              child: isUploading
                ...
                child: Text(
                  ...
                  : Center(
                child: Text(
                  AppLocalizations.of(context)!.noImageUploaded,
                  style: GoogleFonts.poppins(
                    fontSize: 18,
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: SlideAction(
                innerColor: Colors.white,
                outerColor: (imageUrl != null && textSweetTalk.text.isNotEmpty)
                    ? Colors.blue[800]!
                    : Colors.grey,
                elevation: 10,
                textColor: Colors.white,
                ...
                sliderButtonIcon: Icon(
                  Icons.send,
                  size: 20,
                  color: (imageUrl != null && textSweetTalk.text.isNotEmpty)
                      ? Colors.blue[800]
                      : Colors.grey,
                ),
                submittedIcon: Icon(
                ...
                onSubmit: () async {
                  ...
                  church: ${authProviders.churchCodeL},
                  stage: "${authProviders.stageTypeL!}_${authProviders.stageYearL}",
                  sweetTalk text: ${textSweetTalk.text}
                  ''');

                  if (isValidForm()) {
                    if (imageUrl != null) {
                      print('Saving image URL to Firestore...');
                      await New_fire_base_set_data_for_leader.saveImageSweetTalkUrlToFirestore(
                        imageUrl: imageUrl!,
                        governorate: authProviders.governorate!,
                        church: authProviders.churchCodeL!,
                        stage: "${authProviders.stageTypeL!}_${authProviders.stageYearL}",
                    ...
                    print('Saving SweetTalk data...');
                    New_fire_base_set_data_for_leader.sweetTalkSet(
                      sweetTalk: textSweetTalk.text,
                      imageUrl: imageUrl!,
                      governorate: authProviders.governorate!,
                      church: authProviders.churchCodeL!,
                      stage: "${authProviders.stageTypeL!}_${authProviders.stageYearL}", leader: authProviders.nameL!,
                    );
